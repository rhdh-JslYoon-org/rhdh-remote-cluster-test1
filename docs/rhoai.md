...
2) Go to the `Data Science Projects` section and access your application's project named `lucas2`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rhdh-remote-cluster-test1-notebook`.
...
5) In the terminal, run `cd rhdh-remote-cluster-test1` to navigate to your sample app's directory.
